...
**Data**: 2230 kanji (N5=80, N4=166, N3=367, N2=373, N1=1244); 9 sentences each; 7173 vocab (N5=657, N4=588, N3=1625, N2=1589, N1=920, Other=1794); JLPT questions N5=465, N4=529  
**DB**: SQLite ~29 MB; `_assetDbVersion=10`; 695 vocab tagged `usually_kana`; 1794 vocab level 0 ("other" — not in Core 6k, browsable via Other button in select vocab); 10919 `compound_glosses` (sentence compounds absent from vocab)  
...
11. **Asset DB versioning**: `_assetDbVersion=10`. Bump to ship new `kanji.db`. All user-state tables (`_userTables`) survive the rebuild.
